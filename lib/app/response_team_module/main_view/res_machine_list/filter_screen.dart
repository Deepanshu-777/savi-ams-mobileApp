...
class FilterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ResMachineListController>(
      init: ResMachineListController(),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  //   () => statusContainer(
                  //     title: "In-Active",
                  //     boxColor: controller.currentConditionIndex.value == 1
                  //         ? AppColors.navyBlue
                  //         : null,
                  //     hPadding: 14.5,
                  //     statusIndex: 1,
                  //     onTap: () => controller.changeCurrentConditionIndex(
                  //         controller.currentConditionIndex.value == 1 ? 5 : 1),
                  //   ),
                  // ),
                  // customSizedBox(width : 11.2),
                  Obx(
                    () => statusContainer(
                      ...
                      onTap: () {
                        controller.changeCurrentMachineStatusIndex(5);
                        controller.changeCurrentConditionIndex(
                          controller.currentConditionIndex.value == 2 ? 5 : 2,
                        );
                      },
                    ),
                  )
...
Widget shopListing({
  ...
  ResMachineListController controller = Get.find<ResMachineListController>();
  return Obx(
    () {
