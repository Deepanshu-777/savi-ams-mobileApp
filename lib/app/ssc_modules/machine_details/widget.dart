...
import '../../response_team_module/res_machine_details/widget.dart';

List<Widget> body({
  double height = 10,
  double width = 20,
}) {
  MachineDetailsController controller = Get.find<MachineDetailsController>();
  return [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          if (machineDetails?.ifDcRequestRaisedFor == false)
                            machineDetails?.status == 'Condemned'
                                ...
                                : SizedBox(
                                    ...
                                    child: customElevatedButtonIcon(
                                      ...
                                      title: 'Request Condemnation',
                                      bgColor: Colors.white,
                                      fontSize: 12.5,
                                      fontWeight: FontWeight.w600,
                                      fontColor: const Color(0xFF2B2E63),
                                      border: const BorderSide(
                                          color: Color(0xFF2B2E63)),
                                      isWidget: true,
...
Widget machineStatusDropdown({
  ...
  required MachineDetailsController controller,
}) {
...
Widget requestCondemnationSheet(BuildContext context) {
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        titleTextField(
          controller: controller.raisedByRemarks,
        ...
        SizedBox(
          ...
          child: customElevatedButtonIcon(
            onPressed: () async {
              if (controller.machineBase64.value.isEmpty) {
                customToast(
                    msg:
                        "Please upload a support attachment for condemnation.");
                return;
              }

              if (controller.raisedByRemarks.text.trim().isEmpty) {
                customToast(
                    msg:
                        "Please provide remarks explaining why this machine should be condemned.");
              }
              Get.back();
              await controller.requestMachineCondemnation(
                machine_id: (machineDetails?.id ?? "").toString(),
                type: 'condemnation',
                request_by_remarks: controller.raisedByRemarks.text,
                support_attachment: controller.machineBase64.value,
              );
            },
            title: 'Submit',
            bgColor: const Color(0xFF2B2E63),
            fontColor: Colors.white,
                    ...
                    (index) => Obx(
                      () => Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: (controller.isMachineImageSelected.value ==
                                        false)
...
Widget buildCondemnationRequestCard({
  ...
  String status = requestDetails.status ?? 'Pending';
...
void showCodemnRequestDetailBottomSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (_) {
      ...
      MachineDetailsController controller =
          ...
          child:
            ...
            Column(
              children: [
                Center(
                  child: smallText(
                    title: requestDetails.status?.toLowerCase() == 'approved'
