                    ...
                    child: Container(
                      ...
                      child: MobileScanner(
                        ...
                        onDetect: (captures) {
                          ...
                          if (image != null) {
                            log("machine_id => ${controller.data?["machine_id"]}");
                            log("maintenance_date => ${controller.data?["maintenance_date"]}");

                            controller.data?["after_barcode"] != null
                                ? {
                                    log("${controller.data?["machine_id"]}  ${machineId}"),
                                    controller.data?["machine_id"].toString() ==
                                            machineId.toString()
                                        ? {
                                            Get.offNamed(
                                              Routes.REMARK,
